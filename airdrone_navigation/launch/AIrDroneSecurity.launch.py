...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        SetEnvironmentVariable('GAZEBO_MODEL_PATH', HOME + '/px4_ros_com_ros2/src/aidrone_navigation/models'),
	#SetEnvironmentVariable('GAZEBO_MODEL_PATH', HOME + 'px4_ros_com_ros2/install/px4_ros_com/share/px4_ros_com/models'),
