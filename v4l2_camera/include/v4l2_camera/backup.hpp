...
private:
  ...
  rclcpp::Subscription<vision_msgs::msg::BoundingBox2D>::SharedPtr lt_detection_sub_;
  ...
  mutable std::vector<vision_msgs::msg::BoundingBox2D> lt_detections_;
  ...
  void lt_detection_callback(const vision_msgs::msg::BoundingBox2D::SharedPtr msg) const
  {    
    vision_msgs::msg::BoundingBox2D tempDet;
    tempDet.center = msg->center;
    tempDet.size_x = msg-> size_x;
    tempDet.size_y = msg-> size_y;

    lt_detections_.push_back(tempDet);
  }
